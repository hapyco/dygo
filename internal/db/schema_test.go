...
func TestBuildMetadataSchemaPlanForEmptyDatabase(t *testing.T) {
	...
	for _, want := range []string{
		...
		"create index entity_is_system_idx on entity.is_system",
		...
		appEntity(),
		{
			...
			Entity: schema.Entity{
				...
				Fields: []schema.Field{
					...
					{Name: "is-system", Type: "boolean", Required: true, Index: true, Default: yaml.Node{Kind: yaml.ScalarNode, Tag: "!!bool", Value: "false"}},
